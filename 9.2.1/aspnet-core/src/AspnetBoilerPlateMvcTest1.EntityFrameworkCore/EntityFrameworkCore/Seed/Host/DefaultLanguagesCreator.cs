...
namespace AspnetBoilerPlateMvcTest1.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AspnetBoilerPlateMvcTest1Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspnetBoilerPlateMvcTest1DbContext context)
        {
            _context = context;
        }
