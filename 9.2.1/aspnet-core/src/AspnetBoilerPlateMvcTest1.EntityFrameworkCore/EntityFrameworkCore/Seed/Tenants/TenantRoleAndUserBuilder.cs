...
namespace AspnetBoilerPlateMvcTest1.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(AspnetBoilerPlateMvcTest1DbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AspnetBoilerPlateMvcTest1AuthorizationProvider())
