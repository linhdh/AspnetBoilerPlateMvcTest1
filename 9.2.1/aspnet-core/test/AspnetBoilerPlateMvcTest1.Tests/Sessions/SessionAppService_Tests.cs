...
using Shouldly;
using Xunit;
using AspnetBoilerPlateMvcTest1.Sessions;

namespace AspnetBoilerPlateMvcTest1.Tests.Sessions
{
    public class SessionAppService_Tests : AspnetBoilerPlateMvcTest1TestBase
    {
