...
{
    public abstract class AspnetBoilerPlateMvcTest1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspnetBoilerPlateMvcTest1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspnetBoilerPlateMvcTest1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspnetBoilerPlateMvcTest1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspnetBoilerPlateMvcTest1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspnetBoilerPlateMvcTest1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspnetBoilerPlateMvcTest1DbContext, Task<T>> func)
        {
            T result;
